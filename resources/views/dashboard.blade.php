...
<body class="about-us">
  ...
  <nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3 navbar-transparent">
    <div class="container">
      <a class="navbar-brand text-white" href="#" rel="tooltip" data-placement="bottom">
        PBL - 103
      </a>
      ...
      <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0 ms-lg-12 ps-lg-5" id="navigation">
        <ul class="navbar-nav navbar-nav-hover w-100">
          <!-- Link ke halaman Tentang Aplikasi -->
          <li class="nav-item">
            <a class="nav-link text-white" href="#tentang-aplikasi">Tentang Aplikasi</a>
          </li>
          ...
          <li class="nav-item ms-lg-auto">
            <a href="loginpanel" class="btn btn-sm bg-white btn-round mb-0 me-1 mt-2 mt-md-0">Masuk</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <header class="bg-gradient-dark">
    <div class="page-header min-vh-90" style="background-image: url('../assets/img/green-bg.jpg');">
      <span class="mask bg-gradient-success opacity-3"></span>
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center mx-auto my-auto">
            <h1 class="text-white">Aplikasi Patuh Bayar</h1>
            <p class="lead mb-4 text-white opacity-8">Sebuah konstribusi untuk iuran warga yang digunakan untuk biaya operasional, pemeliharaan, dan perawatan fasilitas – fasilitas tersebut, serta untuk meningkatkan kualitas hidup warga.</p>

            <button type="button" class="btn bg-white text-dark" onclick="window.location.href='{{ url('panduanpengguna') }}';">
                Panduan Pengguna
            </button>
  ...
  <section class="py-7" id="tentang-aplikasi">
    <div class="container">
          ...
          <div class="row justify-content-start">
            ...
            <div class="col-md-6">
              <div class="info">
                ...
                <p><b>Aplikasi Patuh Bayar</b> mempermudah pencatatan iuran warga secara otomatis dan sistematis, mengurangi kesalahan manual.</p>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="info">
                ...
                <h5>Pengelolaan Data</h5>
                <p>Mendukung pengelolaan data pembayaran warga, termasuk riwayat, laporan rekap, dan histori pembayaran.</p>
              </div>
            </div>
          ...
          <div class="row justify-content-start">
            ...
            <div class="col-md-6">
              <div class="info">
                ...
                <p>Dilengkapi fitur pengiriman notifikasi via email untuk mengingatkan batas waktu pembayaran.</p>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="info">
                ...
                <h5>Keamanan Sistem</h5>
                <p>Sistem berbasis web, aman dengan enkripsi SSL/TLS, dan responsif dalam 5 detik.</p>
              </div>
            </div>
          ...
          <div class="card shadow-lg">
            <div class="card-header p-0 mx-3 mt-3 position-relative z-index-1">
              <div class="d-block blur-shadow-image">
                <img src="https://i.pinimg.com/736x/ac/5c/40/ac5c402ab6f7cc64e6b7e59676a2ff07.jpg" alt="img-blur-shadow" class="img-fluid shadow rounded-3">
              </div>
            ...
            <div class="card-body">
              <a href="javascript:;">
                <h5 class="mt-3">Patuh Bayar</h5>
              </a>
              <p>
                <b>Patuh Bayar</b> adalah aplikasi web untuk pencatatan dan pengelolaan iuran warga secara  sistematis dengan notifikasi email dan keamanan tinggi.
              </p>
            </div>
          </div>
        </div>
  ...
  <section class="pt-sm-8 pb-5 position-relative bg-gradient-dark" id="tentang-kami">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 text-start mb-5 mt-5">
          <h3 class="text-white z-index-1 position-relative">PBL 103 Team</h3>
          <p class="text-white opacity-8 mb-0">Anggota tim aplikasi web Patuh Bayar serta bagian bidang keahlian</p>
        </div>
      </div>
      <div class="row">
          ...
          <div class="card card-profile overflow-hidden">
              ...
              <div class="col-lg-4 col-md-6 col-12 pe-lg-0">
                <a href="javascript:;">
                  <div class="p-3 pe-md-0">
                    <img class="w-100 border-radius-md" src="../assets/img/anggota/Dhomi.png" alt="image">
                  </div>
                </a>
              </div>
            ...
            <div class="row">
              <div class="col-lg-4 col-md-6 col-12 pe-lg-0">
                <a href="javascript:;">
                  <div class="p-3 pe-md-0">
                    <img class="w-100 border-radius-md" src="../assets/img/anggota/Vioni.png" alt="image">
                  </div>
                </a>
              </div>
              <div class="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
          ...
          <div class="card card-profile mt-lg-0 mt-5 overflow-hidden">
            ...
            <div class="row">
              <div class="col-lg-4 col-md-6 col-12 pe-lg-0">
                <a href="javascript:;">
                  <div class="p-3 pe-md-0">
                    <img class="w-100 border-radius-md" src="../assets/img/anggota/Syifa.png" alt="image">
                  </div>
                </a>
              </div>
              <div class="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
            ...
            <div class="row">
              <div class="col-lg-4 col-md-6 col-12 pe-lg-0">
                <a href="javascript:;">
                  <div class="p-3 pe-md-0">
                    <img class="w-100 border-radius-md" src="../assets/img/anggota/Hanif.png" alt="image">
                  </div>
                </a>
              </div>
              <div class="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
          ...
          <div class="card card-profile overflow-hidden z-index-2">
            <div class="row">
              <div class="col-lg-4 col-md-6 col-12 pe-lg-0">
                <a href="javascript:;">
                  <div class="p-3 pe-md-0">
                    <img class="w-100 border-radius-md" src="../assets/img/anggota/Mifta.png" alt="image">
                  </div>
                </a>
              </div>
              <div class="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
          ...
          <div class="card card-profile mt-lg-0 mt-5 overflow-hidden z-index-2">
            <div class="row">
              <div class="col-lg-4 col-md-6 col-12 pe-lg-0">
                <a href="javascript:;">
                  <div class="p-3 pe-md-0">
                    <img class="w-100 border-radius-md" src="../assets/img/anggota/Farhan.png" alt="image">
                  </div>
                </a>
              </div>
              <div class="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
